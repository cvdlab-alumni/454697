...
//PISTA
var erba = SIMPLEX_GRID([
  [20],
	[-2.2, 0.5],
	[0.1]
	]);

var mantello = SIMPLEX_GRID([
	[20],
	[0.5, -0.1, 3, -0.1, 0.5],
	[0.1]
	]);

var mantello1=COLOR([0, 0, 0])(mantello);
var erba1 = COLOR([0, 1, 0])(erba);
DRAW(T([0, 2])([-10, -1.1])(erba1));
DRAW(T([0, 2, 1])([-10, -1.1, -4.7])(erba1));

var m = T([2, 1, 0])([-1.1, -2, -10])(mantello1);
DRAW(m);